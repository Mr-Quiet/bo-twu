    ...
    const mainFunc = () => {
        ...
        document.addEventListener("click", (function(e) {
            ...
            if (swipers.length) {
                ...
                const swiperProjects = swipers[1].swiper;
